...
export default function ChatBot() {
  ...
  const startChat = () => {
    ...
    addBot(`
      <div class="space-y-2">
        ...
        <div class="text-sm font-semibold text-blue-600 mt-4 font-sans">אנא בחרי שנתון לימודים כדי להתחיל:</div>
      </div>
    `);
  };
  ...
  const sendMessage = async () => {
    ...
    setMessages((p) => [...p, { id: loadingId, sender: "bot", html: "..." }]);
            ...
            <div className="flex gap-4 items-center">
                <div className="flex-1 relative">
                    <input
                        ...
                        placeholder="הקלידי שאלה חופשית כאן..."
